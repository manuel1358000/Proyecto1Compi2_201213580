...
Contenedor1_VentanaPrincipal.crearTexto("Arial",14,"#FF00FF",10,175,falso,verdadero,"Haga clic en el siguiente boton para iniciar el area de reportes ");
...
ContenedorLogica_VentanaLogica.crearCajaTexto(25,200,"Arial",14,"#AAAFDC",150,95,falso,falso,"Ingrese aqui su nombre ","CTNombre");
