...
var btnReportes_Contenedor1_VentanaPrincipal=Contenedor1_VentanaPrincipal.crearboton("ARIAL",14,"#ffffff",60,300,cargar_VentanaReportes(),"Iniciar Reportes ",75,150);
...
var ventana_VentanaAritmetica=crearVentana("#2E2EFE",800,800,"VentanaAritmetica");
var ContenedorAritmeticas_VentanaAritmetica=ventana_VentanaAritmetica.crearContenedor(1000,1000,"#ffffff",verdadero,10,10);
...
ContenedorAritmeticas_VentanaAritmetica.crearCajaTexto(20,100,"Arial",14,"#ffffff",100,50,falso,falso,"Ingrese aqui su nombre ","CTNombre");
ContenedorAritmeticas_VentanaAritmetica.crearTexto("Arial",14,"#000000",10,150,falso,falso,"Ingrese la potencia de 5 a la 5 : ");
ContenedorAritmeticas_VentanaAritmetica.crearControlNumerico(50,100,5000,0,150,150,"0","CPotencia");
var btnPotencia_ContenedorAritmeticas_VentanaAritmetica=ContenedorAritmeticas_VentanaAritmetica.crearboton("ARIAL",14,"#ffffff",300,150,"","Ver Respuesta ",50,100);
...
ContenedorAritmeticas_VentanaAritmetica.crearControlNumerico(50,100,6000,0,150,250,"0","CFactorial");
var btnFactorial_ContenedorAritmeticas_VentanaAritmetica=ContenedorAritmeticas_VentanaAritmetica.crearboton("ARIAL",14,"#ffffff",300,250,"","Ver Respuesta ",50,100);
...
ContenedorAritmeticas_VentanaAritmetica.crearControlNumerico(50,100,100,0,150,350,"0","CInvertido");
var btnInvertido_ContenedorAritmeticas_VentanaAritmetica=ContenedorAritmeticas_VentanaAritmetica.crearboton("ARIAL",14,"#ffffff",300,350,"","Ver Respuesta ",50,100);
...
ContenedorAritmeticas_VentanaAritmetica.crearControlNumerico(50,100,100,0,150,450,"0","CMCD");
var btnMCD_ContenedorAritmeticas_VentanaAritmetica=ContenedorAritmeticas_VentanaAritmetica.crearboton("ARIAL",14,"#ffffff",300,450,"","Ver Respuesta ",50,100);
...
ContenedorAritmeticas_VentanaAritmetica.crearControlNumerico(50,100,6000,0,150,550,"0","CFibonacci");
var btnFibonacci_ContenedorAritmeticas_VentanaAritmetica=ContenedorAritmeticas_VentanaAritmetica.crearboton("ARIAL",14,"#ffffff",300,550,"","Ver Respuesta ",50,100);

btnFibonacci_ContenedorAritmeticas_VentanaAritmetica.alclic(VerFibonacci(19));
var ContEnviarAritmetica_VentanaAritmetica=ventana_VentanaAritmetica.crearContenedor(100,200,"#ffffff",falso,10,1010);
var btnEnviar_ContEnviarAritmetica_VentanaAritmetica=ContEnviarAritmetica_VentanaAritmetica.crearboton("ARIAL",14,"#0000FF",75,30,cargar_VentanaHistoria(),"Contestar ",70,40);
...
var ventana_VentanaHistoria=crearVentana("#2E2EFE",800,800,"VentanaHistoria");
...
var btnPlaya_ContenedorHistoria_VentanaHistoria=ContenedorHistoria_VentanaHistoria.crearboton("ARIAL",14,"#ffffff",500,250,"","Ver Respuesta ",50,100);
...
var btnLuna_ContenedorHistoria_VentanaHistoria=ContenedorHistoria_VentanaHistoria.crearboton("ARIAL",14,"#ffffff",500,400,"","Ver Respuesta ",50,100);
...
var btnSelva_ContenedorHistoria_VentanaHistoria=ContenedorHistoria_VentanaHistoria.crearboton("ARIAL",14,"#ffffff",500,550,"","Ver Respuesta ",50,100);
...
var btnDesierto_ContenedorHistoria_VentanaHistoria=ContenedorHistoria_VentanaHistoria.crearboton("ARIAL",14,"#ffffff",500,700,"","Ver Respuesta ",50,100);
...
var btnOceano_ContenedorHistoria_VentanaHistoria=ContenedorHistoria_VentanaHistoria.crearboton("ARIAL",14,"#ffffff",500,850,"","Ver Respuesta ",50,100);

btnOceano_ContenedorHistoria_VentanaHistoria.alclic(Paisaje(50));
var ContEnviarHistoria_VentanaHistoria=ventana_VentanaHistoria.crearContenedor(100,200,"#ffffff",falso,10,1010);
var btnEnviar_ContEnviarHistoria_VentanaHistoria=ContEnviarHistoria_VentanaHistoria.crearboton("ARIAL",14,"#0000FF",75,30,cargar_VentanaIngles(),"Contestar ",70,40);
...
var ventana_VentanaIngles=crearVentana("#2E2EFE",800,800,"VentanaIngles");
...
var btnAckerman_ContenedorIngles_VentanaIngles=ContenedorIngles_VentanaIngles.crearboton("ARIAL",14,"#ffffff",300,350,"","Ver Respuesta ",50,100);
...
var btnEnviar_ContEnviarIngles_VentanaIngles=ContEnviarIngles_VentanaIngles.crearboton("ARIAL",14,"#0000FF",75,30,cargar_VentanaLogica(),"Contestar ",70,40);
...
var ventana_VentanaLogica=crearVentana("#2E2EFE",800,800,"VentanaLogica");
...
ContenedorLogica_VentanaLogica.crearAreaTexto(150,200,"Arial",14,"#ffffff",150,150,falso,falso,"","CHanoi");
var btnHanoi_ContenedorLogica_VentanaLogica=ContenedorLogica_VentanaLogica.crearboton("ARIAL",14,"#ffffff",300,150,"","Ver Respuesta ",50,100);
...
var btnHF_ContenedorLogica_VentanaLogica=ContenedorLogica_VentanaLogica.crearboton("ARIAL",14,"#ffffff",300,350,"","Ver Respuesta ",50,100);
...
var btnHM_ContenedorLogica_VentanaLogica=ContenedorLogica_VentanaLogica.crearboton("ARIAL",14,"#ffffff",300,450,"","Ver Respuesta ",50,100);
...
var btnPar_ContenedorLogica_VentanaLogica=ContenedorLogica_VentanaLogica.crearboton("ARIAL",14,"#ffffff",300,550,"","Ver Respuesta ",50,100);
...
var btnImpar_ContenedorLogica_VentanaLogica=ContenedorLogica_VentanaLogica.crearboton("ARIAL",14,"#ffffff",300,650,"","Ver Respuesta ",50,100);
...
var btnEnviar_ContEnviarLogicas_VentanaLogica=ContEnviarLogicas_VentanaLogica.crearboton("ARIAL",14,"#0000FF",75,30,cargar_VentanaReportes(),"Contestar ",70,40);
...
var ventana_VentanaReportes=crearVentana("#000000",800,800,"VentanaReportes");
var ContenedorReportes_VentanaReportes=ventana_VentanaReportes.crearContenedor(800,800,"#ffffff",verdadero,10,10);
var btnEvaluacion1_ContenedorReportes_VentanaReportes=ContenedorReportes_VentanaReportes.crearboton("ARIAL",14,"#ffffff",60,40,"","",75,150);
...
var btnEvaluacion2_ContenedorReportes_VentanaReportes=ContenedorReportes_VentanaReportes.crearboton("ARIAL",14,"#ffffff",60,40,"","",75,150);
...
var btnEvaluacion3_ContenedorReportes_VentanaReportes=ContenedorReportes_VentanaReportes.crearboton("ARIAL",14,"#ffffff",60,40,"","",75,150);
...
var btnEvaluacion4_ContenedorReportes_VentanaReportes=ContenedorReportes_VentanaReportes.crearboton("ARIAL",14,"#ffffff",60,40,"","",75,150);
...
var btnEnviar_ContenedorReportes_VentanaReportes=ContenedorReportes_VentanaReportes.crearboton("ARIAL",14,"#0000FF",60,350,"","Sin funcionalidad ",75,150);
